...
var _excluded3 = ["components", "fullWidth", "inputComponent", "label", "multiline", "notched", "slots", "type"];
...
var FormHelperText = React4.forwardRef(function FormHelperText2(inProps, ref) {
  ...
  return (0, import_jsx_runtime5.jsx)(FormHelperTextRoot, _extends({
    as: component,
    ownerState,
    ...
    children: children === " " ? (
      // notranslate needed while Google Translate will not fix zero-width space issue
      _span2 || (_span2 = (0, import_jsx_runtime5.jsx)("span", {
        className: "notranslate",
        children: "​"
      }))
    ) : children
  ...
  return (0, import_jsx_runtime7.jsxs)(React5.Fragment, {
    children: [(0, import_jsx_runtime6.jsx)(SelectSelect, _extends({
      ...
      children: isEmpty(display) ? (
        // notranslate needed while Google Translate will not fix zero-width space issue
        _span3 || (_span3 = (0, import_jsx_runtime6.jsx)("span", {
          className: "notranslate",
          children: "​"
        }))
      ) : display
...
var TextField = React7.forwardRef(function TextField2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTextField"
  });
  ...
  const InputElement = (0, import_jsx_runtime9.jsx)(InputComponent, _extends({
  ...
  return (0, import_jsx_runtime10.jsxs)(TextFieldRoot, _extends({
    className: clsx_default(classes.root, className),
    disabled,
    error,
    fullWidth,
    ...
    children: [label != null && label !== "" && (0, import_jsx_runtime9.jsx)(InputLabel_default, _extends({
      ...
      children: label
    })), select ? (0, import_jsx_runtime9.jsx)(Select_default, _extends({
      "aria-describedby": helperTextId,
      id,
      ...
      children
    })) : InputElement, helperText && (0, import_jsx_runtime9.jsx)(FormHelperText_default, _extends({
      id: helperTextId
    }, FormHelperTextProps, {
      children: helperText
    }))]
...
//# sourceMappingURL=chunk-X4N73I6P.js.map
